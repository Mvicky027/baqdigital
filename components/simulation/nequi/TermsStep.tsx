    ...
    return (
        <div className="flex flex-col h-full bg-white p-6">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="w-8 h-8 bg-[#da0081] rounded-full flex items-center justify-center text-white font-bold shrink-0 ml-2">12</div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto pr-2 text-xs text-gray-600 space-y-3 mb-4">
                ...
                <p><span className="text-[#da0081] font-bold">Tu Nequi:</span> Es un Depósito de Bajo Monto ligado a tu celular u otros datos que elijas en el sistema de pagos. Solo puedes tener uno con nosotros.</p>
                ...
                <p>¡Hola! Nos encanta que quieras tener Nequi para manejar la plata #ATuRitmo. Con la aceptación de este Reglamento das el paso final para abrir tu Depósito de Bajo Monto, más conocido como 'Tu Nequi'. Este Depósito de Bajo Monto es habilitado por BANCOLOMBIA S.A. a través de su línea de negocio Nequi (en adelante "Nequi"), y tiene los términos y condiciones que te contamos a continuación.</p>
