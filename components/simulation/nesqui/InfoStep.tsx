...
export function InfoStep({ onNext, onBack }: InfoStepProps) {
    return (
        <div className="flex flex-col h-full bg-white p-6">
            ...
            <p className="text-[#059669] text-sm font-medium mb-6">Tus nombres</p>

            <div className="space-y-4 mb-8">
                <div className="bg-emerald-50 p-4 rounded-lg">
                    <label className="block text-xs text-[#059669] mb-1">Primer nombre *</label>
                ...
                <div className="bg-emerald-50 p-4 rounded-lg">
                    <label className="block text-xs text-[#059669] mb-1">Primer apellido *</label>
                    <input type="text" className="w-full bg-transparent border-none outline-none text-[#130016] font-medium" defaultValue="C" />
                </div>
                <div className="bg-emerald-50 p-4 rounded-lg">
                    <label className="block text-xs text-[#059669] mb-1">Segundo apellido (opcional)</label>
                    <input type="text" className="w-full bg-transparent border-none outline-none text-[#130016] font-medium" defaultValue="G" />
                </div>
            </div>

            <p className="text-[#059669] text-sm font-medium mb-2">¿Cómo quieres que te llamemos?</p>
            ...
            <p className="text-[#059669] text-sm font-medium mb-2">Info adicional</p>
            <div className="bg-emerald-50 p-4 rounded-lg mb-8 flex justify-between items-center">
                <div>
                    <label className="block text-xs text-[#059669]">País de residencia *</label>
