    ...
    return (
        <div className="flex flex-col h-full bg-white p-6 relative">
            ...
            <p className="text-gray-500 text-sm mb-4">
                Te enviaremos a tu correo el contrato de tu Nesqui y la confirmación de creación.
            </p>
            ...
            <button
                ...
                className={`w-full py-4 rounded-lg font-medium text-white text-lg transition-colors ${email && email === confirmEmail ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-emerald-200 cursor-not-allowed'
                    }`}
            >
                Confirma tu correo
            </button>
